  ...
  return (
    <div className="home-page-container">
      ...
      <div className="home-page-content">
        Device we use is Raspberry Pi and, in our case, it measures temperature,
        humidity and pollution of the air around us.
        <br />
        In the first week of internship, you were using this little buddy’s data
        stored in database to create{" "}
        <a
        ...
        is JavaScript library for building user interfaces and UI components and
        we will be using it to manipulate with our data in several ways:
        <ul className="list">
